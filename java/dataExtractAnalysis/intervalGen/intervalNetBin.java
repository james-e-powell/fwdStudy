        ...
        while (rs.next()) {
          ...
          while (rs2.next()) {
            ...
            if (!(lastValue.equals("")) && (!(lastInterval.equals("")))) {
              String hashIndex = "{\"source\":\"" + lastInterval + "," + lastValue + "\",\"target\":\"" + thisInterval + "," + thisValue + "\"";
              if (!(Vertices.contains(thisInterval+","+thisValue))) {
                Vertices.add(thisInterval+","+thisValue);
                System.out.println(thisInterval+","+thisValue);
              }
